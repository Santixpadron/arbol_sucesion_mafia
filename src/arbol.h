...
struct Miembro {
    ...
    int fue_jefe;
    int es_jefe;
    Miembro *izq; // primer sucesor
    Miembro *der; // segundo sucesor
};
...
// Insertar un miembro segun su id_jefe
...
// Primer sucesor vivo y libre en un subarbol
Miembro *primer_sucesor_vivo_libre(Miembro *nodo);

// Primer sucesor vivo (incluyendo presos)
